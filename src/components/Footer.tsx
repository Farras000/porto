...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative z-10 border-t border-white/10 py-8 sm:py-12 px-5 sm:px-8 md:px-16 lg:px-24 bg-[#05070a]/90 backdrop-blur-md">
      <Reveal stagger={0.1} className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 font-mono text-xs text-slate-500 text-center sm:text-left">
        ...
        <button
          onClick={scrollToTop}
          className="hover-lift flex items-center gap-2 text-slate-400 hover:text-[#c4f041] transition-colors group cursor-pointer p-1"
        >
